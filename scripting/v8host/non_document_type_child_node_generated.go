...
func (w nonDocumentTypeChildNodeV8Wrapper) Constructor(cbCtx *argumentHelper) js.CallbackRVal {
	cbCtx.logger().Debug("V8 Function call: NonDocumentTypeChildNode.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w nonDocumentTypeChildNodeV8Wrapper) previousElementSibling(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w nonDocumentTypeChildNodeV8Wrapper) nextElementSibling(cbCtx *argumentHelper) js.CallbackRVal {
