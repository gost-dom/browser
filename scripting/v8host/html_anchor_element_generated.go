...
func (w htmlAnchorElementV8Wrapper) Constructor(cbCtx *argumentHelper) (js.Value, error) {
	cbCtx.logger().Debug("V8 Function call: HTMLAnchorElement.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w htmlAnchorElementV8Wrapper) target(cbCtx *argumentHelper) (js.Value, error) {
...
func (w htmlAnchorElementV8Wrapper) setTarget(cbCtx *argumentHelper) (js.Value, error) {
