...
func (w historyV8Wrapper) Constructor(cbCtx *argumentHelper) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: History.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w historyV8Wrapper) go_(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) back(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) forward(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) pushState(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) replaceState(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) length(cbCtx *argumentHelper) (jsValue, error) {
...
func (w historyV8Wrapper) state(cbCtx *argumentHelper) (jsValue, error) {
