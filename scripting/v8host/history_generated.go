...
func (w historyV8Wrapper) Constructor(cbCtx *v8CallbackContext) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: History.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w historyV8Wrapper) go_(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) back(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) forward(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) pushState(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) replaceState(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) length(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w historyV8Wrapper) state(cbCtx *v8CallbackContext) (jsValue, error) {
