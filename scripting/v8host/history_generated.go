...
func (w historyV8Wrapper) Constructor(cbCtx *argumentHelper) (js.Value, error) {
	cbCtx.logger().Debug("V8 Function call: History.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w historyV8Wrapper) go_(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) back(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) forward(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) pushState(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) replaceState(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) length(cbCtx *argumentHelper) (js.Value, error) {
...
func (w historyV8Wrapper) state(cbCtx *argumentHelper) (js.Value, error) {
