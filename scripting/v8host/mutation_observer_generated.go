...
func (w mutationObserverV8Wrapper) Constructor(cbCtx *argumentHelper) (js.Value, error) {
...
func (w mutationObserverV8Wrapper) observe(cbCtx *argumentHelper) (js.Value, error) {
...
func (w mutationObserverV8Wrapper) disconnect(cbCtx *argumentHelper) (js.Value, error) {
...
func (w mutationObserverV8Wrapper) takeRecords(cbCtx *argumentHelper) (js.Value, error) {
