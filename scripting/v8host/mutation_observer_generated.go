...
func (w mutationObserverV8Wrapper) Constructor(cbCtx *argumentHelper) (jsValue, error) {
...
func (w mutationObserverV8Wrapper) observe(cbCtx *argumentHelper) (jsValue, error) {
...
func (w mutationObserverV8Wrapper) disconnect(cbCtx *argumentHelper) (jsValue, error) {
...
func (w mutationObserverV8Wrapper) takeRecords(cbCtx *argumentHelper) (jsValue, error) {
