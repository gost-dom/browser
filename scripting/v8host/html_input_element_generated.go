...
func (w htmlInputElementV8Wrapper) Constructor(cbCtx *v8CallbackContext) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: HTMLInputElement.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w htmlInputElementV8Wrapper) checkValidity(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlInputElementV8Wrapper) type_(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlInputElementV8Wrapper) setType(cbCtx *v8CallbackContext) (jsValue, error) {
