...
func (w htmlTemplateElementV8Wrapper) Constructor(cbCtx *v8CallbackContext) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: HTMLTemplateElement.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w htmlTemplateElementV8Wrapper) content(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) shadowRootMode(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootMode(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) shadowRootDelegatesFocus(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootDelegatesFocus(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) shadowRootClonable(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootClonable(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) shadowRootSerializable(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootSerializable(cbCtx *v8CallbackContext) (jsValue, error) {
