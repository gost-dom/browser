...
func (w htmlTemplateElementV8Wrapper) Constructor(cbCtx *argumentHelper) js.CallbackRVal {
	cbCtx.logger().Debug("V8 Function call: HTMLTemplateElement.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w htmlTemplateElementV8Wrapper) content(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) shadowRootMode(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootMode(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) shadowRootDelegatesFocus(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootDelegatesFocus(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) shadowRootClonable(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootClonable(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) shadowRootSerializable(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w htmlTemplateElementV8Wrapper) setShadowRootSerializable(cbCtx *argumentHelper) js.CallbackRVal {
