...
func newNodeV8Wrapper(scriptHost jsScriptEngine) *nodeV8Wrapper[jsTypeParam] {
	return &nodeV8Wrapper[jsTypeParam]{newHandleReffedObject[dom.Node, jsTypeParam](scriptHost)}
}
