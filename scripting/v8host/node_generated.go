...
func (w nodeV8Wrapper) Constructor(cbCtx *argumentHelper) (js.Value, error) {
	cbCtx.logger().Debug("V8 Function call: Node.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w nodeV8Wrapper) getRootNode(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) cloneNode(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) isSameNode(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) contains(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) insertBefore(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) appendChild(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) removeChild(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) nodeName(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) isConnected(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) ownerDocument(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) parentElement(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) childNodes(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) firstChild(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) previousSibling(cbCtx *argumentHelper) (js.Value, error) {
...
func (w nodeV8Wrapper) nextSibling(cbCtx *argumentHelper) (js.Value, error) {
