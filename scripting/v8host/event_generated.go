...
func (w eventV8Wrapper) Constructor(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) stopPropagation(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) preventDefault(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) type_(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) target(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) currentTarget(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) bubbles(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) cancelable(cbCtx *argumentHelper) (jsValue, error) {
...
func (w eventV8Wrapper) defaultPrevented(cbCtx *argumentHelper) (jsValue, error) {
