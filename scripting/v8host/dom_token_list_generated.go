...
func (w domTokenListV8Wrapper) Constructor(cbCtx *argumentHelper) (js.Value, error) {
	cbCtx.logger().Debug("V8 Function call: DOMTokenList.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w domTokenListV8Wrapper) item(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) contains(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) add(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) remove(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) replace(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) supports(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) length(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) value(cbCtx *argumentHelper) (js.Value, error) {
...
func (w domTokenListV8Wrapper) setValue(cbCtx *argumentHelper) (js.Value, error) {
