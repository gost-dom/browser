...
func (w domTokenListV8Wrapper) Constructor(cbCtx *v8CallbackContext) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: DOMTokenList.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w domTokenListV8Wrapper) item(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) contains(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) add(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) remove(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) replace(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) supports(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) length(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) value(cbCtx *v8CallbackContext) (jsValue, error) {
...
func (w domTokenListV8Wrapper) setValue(cbCtx *v8CallbackContext) (jsValue, error) {
