...
func (w mutationRecordV8Wrapper) Constructor(cbCtx *argumentHelper) js.CallbackRVal {
	cbCtx.logger().Debug("V8 Function call: MutationRecord.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w mutationRecordV8Wrapper) type_(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) target(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) addedNodes(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) removedNodes(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) previousSibling(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) nextSibling(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) attributeName(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) attributeNamespace(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w mutationRecordV8Wrapper) oldValue(cbCtx *argumentHelper) js.CallbackRVal {
