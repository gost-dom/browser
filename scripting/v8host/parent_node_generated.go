...
func (w parentNodeV8Wrapper) Constructor(cbCtx *argumentHelper) js.CallbackRVal {
	cbCtx.logger().Debug("V8 Function call: ParentNode.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w parentNodeV8Wrapper) querySelector(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w parentNodeV8Wrapper) querySelectorAll(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w parentNodeV8Wrapper) firstElementChild(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w parentNodeV8Wrapper) lastElementChild(cbCtx *argumentHelper) js.CallbackRVal {
...
func (w parentNodeV8Wrapper) childElementCount(cbCtx *argumentHelper) js.CallbackRVal {
