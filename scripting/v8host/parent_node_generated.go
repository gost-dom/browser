...
func (w parentNodeV8Wrapper) Constructor(cbCtx *argumentHelper) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: ParentNode.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w parentNodeV8Wrapper) querySelector(cbCtx *argumentHelper) (jsValue, error) {
...
func (w parentNodeV8Wrapper) querySelectorAll(cbCtx *argumentHelper) (jsValue, error) {
...
func (w parentNodeV8Wrapper) firstElementChild(cbCtx *argumentHelper) (jsValue, error) {
...
func (w parentNodeV8Wrapper) lastElementChild(cbCtx *argumentHelper) (jsValue, error) {
...
func (w parentNodeV8Wrapper) childElementCount(cbCtx *argumentHelper) (jsValue, error) {
