...
func (w htmlOrSVGElementV8Wrapper) Constructor(cbCtx *argumentHelper) (jsValue, error) {
	cbCtx.logger().Debug("V8 Function call: HTMLOrSVGElement.Constructor")
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w htmlOrSVGElementV8Wrapper) blur(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) dataset(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) nonce(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) setNonce(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) autofocus(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) setAutofocus(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) tabIndex(cbCtx *argumentHelper) (jsValue, error) {
...
func (w htmlOrSVGElementV8Wrapper) setTabIndex(cbCtx *argumentHelper) (jsValue, error) {
