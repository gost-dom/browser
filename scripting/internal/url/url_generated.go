...
func (w URL[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.Constructor", js.LogAttr("res", res))
	}()
...
func (w URL[T]) toJSON(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.toJSON", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.toJSON", js.LogAttr("res", res))
	}()
...
func (w URL[T]) href(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.href", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.href", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setHref(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setHref", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setHref", js.LogAttr("res", res))
	}()
...
func (w URL[T]) origin(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.origin", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.origin", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) protocol(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.protocol", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.protocol", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setProtocol(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setProtocol", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setProtocol", js.LogAttr("res", res))
	}()
...
func (w URL[T]) username(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.username", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.username", js.LogAttr("res", res))
	}()
...
func (w URL[T]) setUsername(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setUsername", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setUsername", js.LogAttr("res", res))
	}()
...
func (w URL[T]) password(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.password", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.password", js.LogAttr("res", res))
	}()
...
func (w URL[T]) setPassword(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setPassword", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setPassword", js.LogAttr("res", res))
	}()
...
func (w URL[T]) host(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.host", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.host", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setHost(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setHost", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setHost", js.LogAttr("res", res))
	}()
...
func (w URL[T]) hostname(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.hostname", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.hostname", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setHostname(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setHostname", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setHostname", js.LogAttr("res", res))
	}()
...
func (w URL[T]) port(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.port", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.port", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setPort(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setPort", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setPort", js.LogAttr("res", res))
	}()
...
func (w URL[T]) pathname(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.pathname", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.pathname", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setPathname(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setPathname", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setPathname", js.LogAttr("res", res))
	}()
...
func (w URL[T]) search(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.search", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.search", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setSearch(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setSearch", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setSearch", js.LogAttr("res", res))
	}()
...
func (w URL[T]) searchParams(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.searchParams", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.searchParams", js.LogAttr("res", res))
	}()
...
func (w URL[T]) hash(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.hash", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.hash", js.LogAttr("res", res))
	}()
	instance, err := js.As[*url.URL](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w URL[T]) setHash(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: URL.setHash", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: URL.setHash", js.LogAttr("res", res))
	}()
