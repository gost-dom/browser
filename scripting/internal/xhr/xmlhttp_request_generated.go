...
func (w XMLHttpRequest[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.Constructor", js.LogAttr("res", res))
	}()
...
func (w XMLHttpRequest[T]) setRequestHeader(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.setRequestHeader", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.setRequestHeader", js.LogAttr("res", res))
	}()
...
func (w XMLHttpRequest[T]) send(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.send", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.send", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w XMLHttpRequest[T]) abort(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.abort", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.abort", js.LogAttr("res", res))
	}()
...
func (w XMLHttpRequest[T]) getResponseHeader(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.getResponseHeader", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.getResponseHeader", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w XMLHttpRequest[T]) getAllResponseHeaders(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.getAllResponseHeaders", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.getAllResponseHeaders", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) overrideMimeType(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.overrideMimeType", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.overrideMimeType", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w XMLHttpRequest[T]) readyState(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.readyState", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.readyState", js.LogAttr("res", res))
	}()
...
func (w XMLHttpRequest[T]) timeout(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.timeout", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.timeout", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) setTimeout(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.setTimeout", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.setTimeout", js.LogAttr("res", res))
	}()
...
func (w XMLHttpRequest[T]) withCredentials(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.withCredentials", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.withCredentials", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) setWithCredentials(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.setWithCredentials", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.setWithCredentials", js.LogAttr("res", res))
	}()
	instance, err0 := js.As[html.XMLHttpRequest](cbCtx.Instance())
...
func (w XMLHttpRequest[T]) responseURL(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.responseURL", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.responseURL", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) status(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.status", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.status", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) statusText(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.statusText", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.statusText", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) responseType(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.responseType", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.responseType", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) setResponseType(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.setResponseType", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.setResponseType", js.LogAttr("res", res))
	}()
	instance, err0 := js.As[html.XMLHttpRequest](cbCtx.Instance())
...
func (w XMLHttpRequest[T]) response(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.response", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.response", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) responseText(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.responseText", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.responseText", js.LogAttr("res", res))
	}()
	instance, err := js.As[html.XMLHttpRequest](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w XMLHttpRequest[T]) responseXML(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequest.responseXML", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequest.responseXML", js.LogAttr("res", res))
	}()
