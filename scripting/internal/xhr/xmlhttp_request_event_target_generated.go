...
func (w XMLHttpRequestEventTarget[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: XMLHttpRequestEventTarget.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: XMLHttpRequestEventTarget.Constructor", js.LogAttr("res", res))
	}()
