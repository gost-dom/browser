...
func (w Headers[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.Constructor", js.LogAttr("res", res))
	}()
...
func (w Headers[T]) append(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.append", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.append", js.LogAttr("res", res))
	}()
...
func (w Headers[T]) delete(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.delete", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.delete", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[fetch.Headers](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w Headers[T]) get(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.get", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.get", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[fetch.Headers](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w Headers[T]) getSetCookie(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.getSetCookie", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.getSetCookie", js.LogAttr("res", res))
	}()
...
func (w Headers[T]) has(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.has", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.has", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[fetch.Headers](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w Headers[T]) set(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Headers.set", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Headers.set", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[fetch.Headers](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
