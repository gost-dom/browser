...
// code can switch between script engines.
//
...
//
// - Using an engine that you know contains latest ES standards (V8)
...
// JavaScriptCore (Safari), you could verify your code using the script engines
