...
func (w ReadableStreamDefaultReader[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamDefaultReader.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: ReadableStreamDefaultReader.Constructor", js.LogAttr("res", res))
	}()
...
func (w ReadableStreamDefaultReader[T]) read(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamDefaultReader.read", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: ReadableStreamDefaultReader.read", js.LogAttr("res", res))
	}()
...
func (w ReadableStreamDefaultReader[T]) releaseLock(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamDefaultReader.releaseLock", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: ReadableStreamDefaultReader.releaseLock", js.LogAttr("res", res))
	}()
