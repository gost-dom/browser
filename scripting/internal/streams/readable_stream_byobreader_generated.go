...
func (w ReadableStreamBYOBReader[T]) Constructor(cbCtx js.CallbackContext[T]) (js.Value[T], error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamBYOBReader.Constructor")
...
func (w ReadableStreamBYOBReader[T]) read(cbCtx js.CallbackContext[T]) (js.Value[T], error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamBYOBReader.read")
...
func (w ReadableStreamBYOBReader[T]) releaseLock(cbCtx js.CallbackContext[T]) (js.Value[T], error) {
	cbCtx.Logger().Debug("JS Function call: ReadableStreamBYOBReader.releaseLock")
