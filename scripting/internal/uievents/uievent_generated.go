...
func (w UIEvent[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: UIEvent.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: UIEvent.Constructor", js.LogAttr("res", res))
	}()
...
func (w UIEvent[T]) view(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: UIEvent.view", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: UIEvent.view", js.LogAttr("res", res))
	}()
...
func (w UIEvent[T]) detail(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: UIEvent.detail", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: UIEvent.detail", js.LogAttr("res", res))
	}()
