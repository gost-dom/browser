...
func (w EventTarget[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: EventTarget.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: EventTarget.Constructor", js.LogAttr("res", res))
	}()
	return w.CreateInstance(cbCtx)
}

func (w EventTarget[T]) addEventListener(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: EventTarget.addEventListener", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: EventTarget.addEventListener", js.LogAttr("res", res))
	}()
...
func (w EventTarget[T]) removeEventListener(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: EventTarget.removeEventListener", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: EventTarget.removeEventListener", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[event.EventTarget](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
...
func (w EventTarget[T]) dispatchEvent(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: EventTarget.dispatchEvent", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: EventTarget.dispatchEvent", js.LogAttr("res", res))
	}()
	instance, errInst := js.As[event.EventTarget](cbCtx.Instance())
	if errInst != nil {
		return nil, errInst
