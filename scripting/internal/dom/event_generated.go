...
func (w Event[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.Constructor", js.LogAttr("res", res))
	}()
...
func (w Event[T]) stopPropagation(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.stopPropagation", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.stopPropagation", js.LogAttr("res", res))
	}()
...
func (w Event[T]) preventDefault(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.preventDefault", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.preventDefault", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) type_(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.type_", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.type_", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) target(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.target", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.target", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) currentTarget(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.currentTarget", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.currentTarget", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) bubbles(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.bubbles", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.bubbles", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) cancelable(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.cancelable", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.cancelable", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Event[T]) defaultPrevented(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Event.defaultPrevented", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Event.defaultPrevented", js.LogAttr("res", res))
	}()
	instance, err := js.As[*event.Event](cbCtx.Instance())
	if err != nil {
		return nil, err
