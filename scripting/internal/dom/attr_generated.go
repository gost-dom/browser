...
func (w Attr[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.Constructor", js.LogAttr("res", res))
	}()
	return cbCtx.ReturnWithTypeError("Illegal constructor")
}

func (w Attr[T]) localName(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.localName", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.localName", js.LogAttr("res", res))
	}()
...
func (w Attr[T]) name(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.name", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.name", js.LogAttr("res", res))
	}()
	instance, err := js.As[dom.Attr](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Attr[T]) value(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.value", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.value", js.LogAttr("res", res))
	}()
	instance, err := js.As[dom.Attr](cbCtx.Instance())
	if err != nil {
		return nil, err
...
func (w Attr[T]) setValue(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.setValue", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.setValue", js.LogAttr("res", res))
	}()
...
func (w Attr[T]) ownerElement(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: Attr.ownerElement", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: Attr.ownerElement", js.LogAttr("res", res))
	}()
	instance, err := js.As[dom.Attr](cbCtx.Instance())
	if err != nil {
		return nil, err
