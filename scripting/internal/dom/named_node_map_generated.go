...
func (w NamedNodeMap[T]) Constructor(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.Constructor", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.Constructor", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) item(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	...
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.item", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) getNamedItem(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.getNamedItem", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.getNamedItem", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) getNamedItemNS(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.getNamedItemNS", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.getNamedItemNS", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) setNamedItem(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.setNamedItem", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.setNamedItem", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) setNamedItemNS(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.setNamedItemNS", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.setNamedItemNS", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) removeNamedItem(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.removeNamedItem", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.removeNamedItem", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) removeNamedItemNS(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.removeNamedItemNS", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.removeNamedItemNS", js.LogAttr("res", res))
	}()
...
func (w NamedNodeMap[T]) length(cbCtx js.CallbackContext[T]) (res js.Value[T], err error) {
	cbCtx.Logger().Debug("JS Function call: NamedNodeMap.length", js.ThisLogAttr(cbCtx))
	defer func() {
		cbCtx.Logger().Debug("JS Function call return: NamedNodeMap.length", js.LogAttr("res", res))
	}()
