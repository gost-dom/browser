...
func ConfigureEventSpecs(specs *WebIdlConfigurations) {
	...
	mouseEvent.Method("ctrlKey").SetNotImplemented()
	mouseEvent.Method("shiftKey").SetNotImplemented()
	mouseEvent.Method("altKey").SetNotImplemented()
	mouseEvent.Method("metaKey").SetNotImplemented()
	mouseEvent.Method("button").SetNotImplemented()
	mouseEvent.Method("buttons").SetNotImplemented()
