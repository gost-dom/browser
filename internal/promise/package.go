...
//
// In JavaScript, a promise represents an operation that will fullfill with a
...
// will be received.
//
// This package not intended to provide be a full implementation of JavaScript
// promises. The intention is to simplify implementation of web APIs that
// returns promises, e.g. the [fetch API].
//
